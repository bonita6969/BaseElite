            ...
            if not nui and not inTest and timer == 0 and nearestConce and nearestConce.conce then
                ...
                if distance <= 5 then
                    if conceMarker then
                        ...
                        DrawMarker(36, coords, 0, 0, 0, 0, 0, 0, 1.0, 1.0, 1.0, 136, 6, 6, 155, 1, 1, 1, 1)
				    end
                end
        ...
        if mhash then
            ...
            local closestVehicleOnSpot = GetClosestVehicle(spawnCoords.x,spawnCoords.y,spawnCoords.z,3.001,0,71)
                if DoesEntityExist(closestVehicleOnSpot) then
                    ...
                    notify("aviso", "Test Drive iniciado. Não saia do veículo e nem vá para muito longe do local.",3000)
                    ...
                    if inTest then
                        ...
                        notify("aviso", "Test Drive finalizado com sucesso.",3000)
                    end
                        DoScreenFadeOut(1000)
                        Wait(1000)
