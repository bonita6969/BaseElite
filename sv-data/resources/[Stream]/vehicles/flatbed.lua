...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if veh and GetEntityModel(veh) ~= GetHashKey("scaniarepair") then
            veh = lastFlatbed
        end
        if lastFlatbed then
        ...
        if veh and DoesEntityExist(veh) and GetEntityModel(veh) == GetHashKey("scaniarepair") and NetworkHasControlOfEntity(veh) then
            lastFlatbed = veh
