...
-- RegisterNetEvent('esx:playerLoaded555555555555555')
-- AddEventHandler('esx:playerLoaded555555555555555', function(xPlayer)
    -- PlayerData = xPlayer
-- end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
            ...
            TriggerEvent('esx_lift:hasEnteredMarker555555555555555', currentZone)
        end

        if not isInMarker and HasAlreadyEnteredMarker then
            HasAlreadyEnteredMarker = false
            TriggerEvent('esx_lift:hasExitedMarker555555555555555', LastZone)
        end
    end
end)

AddEventHandler('esx_lift:hasExitedMarker555555555555555', function(zone)
...
AddEventHandler('esx_lift:hasEnteredMarker555555555555555', function(zone)
