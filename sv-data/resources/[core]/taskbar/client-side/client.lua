...
-----------------------------------------------------------------------------------------------------------------------------------------
ecb = {}
Tunnel.bindInterface("taskbar",ecb)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local chance = 0
...
-- TASKONE
-----------------------------------------------------------------------------------------------------------------------------------------
function ecb.taskOne()
	local finished = taskBar(3000,12)
	if finished then
		return true
	end
...
-- TASKFISHING
-----------------------------------------------------------------------------------------------------------------------------------------
function ecb.taskFishing()
	local finished = taskBar(10000,2)
	if finished then
		return true
	end
