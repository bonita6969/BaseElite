...
function vRP.upgradeNames(user_id,name,firstname)
	vRP.execute("characters/updateName",{ name = name, firstname = firstname, user_id = user_id })
end

function vRP.upgradeRegistration(user_id,registration)
	vRP.execute("characters/updateRegistro",{ registration = registration, user_id = user_id })
end
