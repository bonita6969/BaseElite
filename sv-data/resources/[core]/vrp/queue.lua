...
Config.Language = {
	joining = "[ CHEGANDO ] Entrando...",
	connecting = "[ DOSSANTOS BASE ] Conectando...",
	err = "[ VACILOU ] Não foi possível identificar sua steam ou Social Club.",
	_err = "[ ESTAMOS CRESCENDO ] Você foi desconectado por demorar demais na fila.",
	pos = "[ AGUENTA FIRME ] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[ DOSSANTOS BASE ] Não foi possível adiciona-lo na fila.",
    wlonly = "[ FAZ A WL AE ] Você não está aprovado na whitelist.",
	banned = "[ MOIÔ ] Seu passaporte foi revogado na cidade.",
	steam = "[ DOSSANTOS BASE ] Você precisa estar com a steam aberta para conectar."
}
