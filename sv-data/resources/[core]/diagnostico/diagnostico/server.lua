...
src = Tunnel.getInterface("diagnostico")
-----------------------------------------------------------------------------------------------------------------------------------------
-- BONES
-----------------------------------------------------------------------------------------------------------------------------------------
local bones = {
		...
		if nplayer then
			...
			if diagnostic then
				...
				if danos == "" then
					...
					TriggerClientEvent("Notify",source,"aviso","Danos encontrados na "..danos.."inicie o tratamento e aguarde o termino até que paciênte fique estável.",30000)
				end
			end
		end
	end
