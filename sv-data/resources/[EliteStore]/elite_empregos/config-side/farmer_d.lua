...
textofarmerd = "~g~[EMPREGOS]\n~w~PRESSIONE ~r~[E]~w~ PARA INICIAR ENTREGAS" -- O que aparece em 3D no "BLIP"

--[ PAYMENT ]----------------------------------------------------------------------------------------------------------------------------

configfarmerd.farmer2 = { 500 , 1000 } -- QUANTIDADE QUE IRA GANHAR POR ROTA, MATH.RANDOM ENTRE 100,300 VOCÊ PODE MUDAR.

--[ START ]----------------------------------------------------------------------------------------------------------------------------

configfarmerd.ini = {
	['x'] = 1709.4, ['y'] = 4725.37, ['z'] = 42.17 -- LOCAL PARA INICIAR A ROTA
}

--[ DELIVERY ]----------------------------------------------------------------------------------------------------------------------------

configfarmerd.farmer1 = "graos" -- ITEM QUE SERA PRECISO PARA FAZER A ROTA

--[ DELIVERY ]----------------------------------------------------------------------------------------------------------------------------

configfarmerd.deliveryss = { 3 , 6 } -- QUANTIDADE QUE SERA NESECESSARIO PARA ENTREGA, MATH.RANDOM ENTRE 3,6 VOCÊ PODE MUDAR.

--[ HASH ]----------------------------------------------------------------------------------------------------------------------------

configfarmerd.lastve = 1026149675 -- HASH DO VEICULO QUE SERA NESECESSARIO PARA ENTREGA DO LEITE, ESTA YOUGA2
