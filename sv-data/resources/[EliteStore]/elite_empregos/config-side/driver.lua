...
textodriver = "~g~[EMPREGOS]\n~w~PRESSIONE ~r~[E]~w~ PARA INICIAR A ROTA" -- O que aparece em 3D no "BLIP"

--[ PAGAMENTO ]----------------------------------------------------------------------------------------------------------------------------

configdriver.min = 35 -- VALOR MÍNIMO QUE O PLAYER RECEBE
configdriver.max = 50 -- VALOR MÁXIMO QUE O PLAYER RECEBE
