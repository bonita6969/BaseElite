...
textofarmer = "~g~[EMPREGOS]\n~w~PRESSIONE ~r~[E]~w~ INICIAR EXPEDIENTE" -- O que aparece em 3D no "BLIP"

configfarmer.quantidade = 2

--[ LOCATION START ]--------------------------------------------------------------------------------------------------------------------

configfarmer.start = {
	{ ['id'] = 1, ['x'] = 751.29, ['y'] = 6459.28, ['z'] = 31.50 }, -- LOCALIZAÇÃO PARA INICIAR A COLHEITA
}

--[ VEHICLE START ]--------------------------------------------------------------------------------------------------------------------

configfarmer.vehicle = "tractor2" -- VEICULO PARA INICIAR A COLHEITA
...
configfarmer.igrain = "graosimpuros" -- NOME DOS GRÃOS COLETADOS

-- [ GRAIN FARMED ] --------------------------------------------------------------------------------------------------------------------

configfarmer.grain = { 1 , 4 } -- QUANTIDADE DOS GRÃOS IMPUROS QUE COLETARÁ

-- [ GRAIN CLEANING LOCATION ] --------------------------------------------------------------------------------------------------------------------

configfarmer.grainclean = {
	{ ['id'] = 1 , ['x'] = 1709.34, ['y'] = 4729.58, ['z'] = 42.16 }, -- LOCAL ONDE LIMPARÁ OS GRÃOS
}

-- [ GRAIN CLEANING ]--------------------------------------------------------------------------------------------------------------------

configfarmer.cgrain = "graos" -- NOME DOS GRÃOS DEPOIS DE LIMPOS

-- [ GRAIN CLEANING ] --------------------------------------------------------------------------------------------------------------------

configfarmer.ugrain = 5 -- QUANTIDADE DE GRAOS NECESSARIOS PARA LIMPAR

--[ GRAIN CLEANEAD ] --------------------------------------------------------------------------------------------------------------------

configfarmer.qgrain = { 3 , 5 } -- QUANTIDADE DE GRAOS GANHOS APOS LIMPAR