...
configlumberjack.tora = "tora" -- Item que será recebido ao cortar a árvore

configlumberjack.random = 3 -- Quantidade aleatória que virá

--[ REQUIRES ]-----------------------------------------------------------------------------------------------------------

-- ITENS PARA CORTAR A ARVORE

configlumberjack.axe = "WEAPON_HATCHET"
configlumberjack.axe1 = "WEAPON_BATTLEAXE" 
